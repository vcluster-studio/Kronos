"""
批量推理脚本 - 第四批：从2025-02-20往前回溯30天到2024-12-31
"""
...
def main():
    ...
    # 第四批：从2025-02-20往前30天到2024-12-31
    start_from_date = '2025-02-20'
    max_days = 30
    ...
    output_path = 'outputs/prediction_results/predictions_mini_part4.sql'
