...
使用预处理的kline_daily_ma60.pkl数据，直接进行推理
"""
...
def main():
    ...
    for pred_date in tqdm(pred_dates, desc="预测进度"):
        ...
        for symbol, data in norm_dict.items():
            ...
            original = data['original'][idx-LOOKBACK:idx]
            ...
            last_closes.append(data['original'][idx-1, 3])  # close price
