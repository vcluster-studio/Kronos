"""
MA60 Predictor Training Script - Mode3 (lookback=60)

使用 MA60 滑动归一化数据训练 predictor。
短 lookback (60步) 与 Mode2 (400步) 对比验证 lookback 影响。
...
Usage:
    python -u finetune/predictor/mode3_ma60_sliding/train_lb60.py
"""
...
# MA60 lb60_pd10 预归一化数据路径
DATA_PATHS = {
    'train': 'finetune/data/ma60_norm/windowed_lb60_pd10/train_data.pkl',
    'val': 'finetune/data/ma60_norm/windowed_lb60_pd10/val_data.pkl',
    'test': 'finetune/data/ma60_norm/windowed_lb60_pd10/test_data.pkl',
}
...
def main():
    ...
    parser.add_argument('--save-folder', type=str, default='mode3_lb60_pd10')
