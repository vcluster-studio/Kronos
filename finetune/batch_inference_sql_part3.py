"""
批量推理脚本 - 第三批：从2025-07-17往前回溯100天到2025-02-20
...
class BatchPredictor:
    ...
    def predict_batch(self, data_dict, lookback=400, pred_len=10, end_indices=None, T=1.0, top_p=0.9):
        ...
        B = len(data_list)
        batch_size = min(B, self.batch_size)
        predictions = {}
...
def main():
    ...
    # 第三批：从2025-07-17往前100天到2025-02-20
    start_from_date = '2025-07-17'
    max_days = 100
    ...
    output_path = 'outputs/prediction_results/predictions_mini_part3.sql'
