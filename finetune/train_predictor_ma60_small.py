...
# 训练参数 — small 模型需要更保守的学习率
TRAINING_PARAMS = {
    'epochs': 30,
    'batch_size': 8,            # small 模型更大，减小 batch
    'learning_rate': 0.02,     # 与 mini 一致，归一化方式变了需要充分探索
    'weight_decay': 0.15,       # 增大正则化防过拟合
    'adam_beta1': 0.9,
    'adam_beta2': 0.95,
    'seed': 100,
    'lookback': 400,
...
# 保存目录
SAVE_FOLDER = 'ma60_predictor_small_v1'
...
def quick_ic_test_ma60(model, tokenizer, device, val_data, n_samples=500,
                       lookback=400, pred_len=10, ic_point=3, clip=5.0, max_context=512,
                       rng=None):
    """IC 测试（使用 val_data，随机采样股票）
