...
def validate_tokenizer(
    ...
    Args:
        ...
        custom_tokenizer_path: 自定义 tokenizer 路径（优先级最高）
        custom_data_path: 自定义数据路径（优先级最高）
...
def main():
    ...
    parser.add_argument('--tokenizer-path', type=str, default=None,
                        help='自定义 tokenizer 路径（优先级最高，覆盖默认路径）')
    parser.add_argument('--data-path', type=str, default=None,
                        help='自定义数据路径（优先级最高，覆盖默认路径）')
